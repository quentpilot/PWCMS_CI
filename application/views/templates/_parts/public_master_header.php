...
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/pe-icon-7-stroke.css') ?>">
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/helper.css') ?>">
<!-- theme stylesheet-->
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/style.default.css') ?>" id="theme-stylesheet">
<!-- owl carousel-->
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/owl.carousel.css') ?>">
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/owl.theme.css') ?>">
<!-- plugins-->
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/simpletextrotator.css') ?>">
<!-- Custom stylesheet - for your changes-->
<link rel="stylesheet" href="<?= site_url('assets/admin/public_master/css/custom.css') ?>">
<!-- Favicon-->
<link rel="shortcut icon" href="<?= site_url('assets/admin/public_master/favicon.png') ?>">
