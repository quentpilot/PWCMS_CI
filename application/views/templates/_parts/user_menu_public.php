<?php defined('BASEPATH') OR exit('No direct script access allowed');?>
	<header class="header">
        <div role="navigation" class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header"><a href="#all" class="navbar-brand scroll-to"><img src="<?= site_url('assets/public/public_master/img/logo.png') ?>" alt="logo" class="hidden-xs hidden-sm"><img src="<?= site_url('assets/public/public_master/img/logo-small.png') ?>" alt="logo" class="visible-xs visible-sm"><span class="sr-only">Go to homepage</span></a>
