  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-8 col-lg-offset-2">
        <p class="margin-bottom--zero"><img alt="" src="<?= site_url('assets/public/public_master/img/features3.png') ?>" class="img-responsive"></p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/kofola.png') ?>" title="Kofola" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/evian.png') ?>" title="Evian" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/cslink.png') ?>" title="CS Link" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/botas66.png') ?>" title="Botas 66 Concept store" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/mdfc.png') ?>" title="MediaFabríca" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
      <div class="col-sm-4 col-md-2 col-xs-6">
        <div class="customer"><img src="<?= site_url('assets/public/public_master/img/customers/vanek.png') ?>" title="VANĚK Strojírenská výroba" data-placement="bottom" data-toggle="tooltip" alt="" class="img-responsive"></div>
      </div>
    </div>
  </div>
</section>
...
<section id="features" class="section">
  <div class="container">
    <div class="row text-center-mobile"> 
      ...
      <div class="col-md-6">
        <p><img alt="" src="<?= site_url('assets/public/public_master/img/features1.png') ?>" class="img-responsive"></p>
      </div>
    </div>
  </div>
</section>
<section class="section background-gray-lightest">
  <div class="container">
    <div class="row text-center-mobile"> 
      <div class="col-md-6">
        <p><img alt="" src="<?= site_url('assets/public/public_master/img/features2.png') ?>" class="img-responsive"></p>
      </div>
      <div class="col-md-6">
        ...
        <ul class="owl-carousel testimonials same-height-row">
          <li class="item">
            <div class="testimonial same-height-always">
              ...
              <div class="bottom">
                ...
                <div class="name-picture"><img alt="" src="<?= site_url('assets/public/public_master/img/person-1.jpg') ?>">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial same-height-always">
              ...
              <div class="bottom">
                <div class="testimonial-icon"> <i class="pe-7s-comment"></i></div>
                <div class="name-picture"><img alt="" src="<?= site_url('assets/public/public_master/img/person-2.jpg') ?>">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial same-height-always">
              ...
              <div class="bottom">
                <div class="testimonial-icon"> <i class="pe-7s-comment"></i></div>
                <div class="name-picture"><img alt="" src="<?= site_url('assets/public/public_master/img/person-3.png') ?>">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial same-height-always">
              ...
              <div class="bottom">
                <div class="testimonial-icon"> <i class="pe-7s-comment"></i></div>
                <div class="name-picture"><img alt="" src="<?= site_url('assets/public/public_master/img/person-4.jpg') ?>">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
        <p class="margin-bottom--zero"><img alt="" src="<?= site_url('assets/public/public_master/img/signup.png') ?>" class="img-responsive"></p>
      </div>
    </div>
  </div>
</section>
